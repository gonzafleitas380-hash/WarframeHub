      ...
      <div id="page-content">
        <nav>
          ...
          {user ? (
            ...
            <div className="auth-buttons">
              ...
              <button className="btn-register" onClick={() => navigate('/registro')}>Registrarse</button>
            </div>
          )};
        ...
        <section className="section">
          <div className="cards">
            ...
            <div className="card"><h3>Última actualización</h3><p>Esta página fue editada por última vez el 27 de Abril del 2026, a las 23:22hs.</p></div>
